...
export const METHODS = {
  pyramid: {
    name: "Восходящая пирамида", origin: "Ронни Колеман",
  ...
  superset: {
    name: "Антагонистический суперсет", origin: "Кевин Леврон",
  ...
  dropset: {
    name: "Каскадный дроп-сет", origin: "Ли Прист",
  ...
  restpause: {
    name: "Кластерный подход", origin: "Кевин Леврон",
  ...
  partials: {
    name: "Растянутые частичные", origin: "Ли Прист",
  ...
  highrep: {
    name: "Метаболический добой", origin: "Ли Прист",
